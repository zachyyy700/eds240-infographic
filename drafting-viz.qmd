...
ggplot(data = age_combined) +
    ...
    geom_point(aes(x = horse_age, y = jra_perc, color = "All Races")) +
    geom_point(aes(x = horse_age, y = ak_perc, color = "Arima Kinen")) +
...
```{r}
ggplot(prize_g1_all) +
    geom_line(aes(x = year, y = prize_money_10kY, group = race_name, color = race_name)) +

    labs(x = "Year", y = "Prize Money") +
