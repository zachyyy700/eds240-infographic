...
ggplot(data = age_combined) +
    ...
    labs(x = "Age", y = "Percentage", title = "Age Comparisons between Arima Kinen & Other Races", subtitle = "") +
...
Since shifting my focus to just one pretigious race, I mainly want to compare the differences between this high level of horse racing and 'lower' levels. 
...
One package needed is the ggtext package as I want to bold names in my winners list that are repeat winners.
