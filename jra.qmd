...
ggplot(ak_93_long, aes(corner_number, position, group = horse_name, color = horse_name)) +
    geom_point(size = 2.5) +
    geom_line() +
    scale_color_hue(labels = c("Wish Dream", "Winning Ticket", "L-Way Win", "El Casa River", "Sekitei Ryu O", "Tokai Teio", "Nice Nature", "Biwa Hayahide", "Vega", "White Stone", "Matikanetannhauser", "Mejiro Palmer", "Rice Shower", "Legacy World"))
```